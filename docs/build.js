...
<html>
<head>
	<title>Selection Utilities Documentation</title>
	<meta charset="utf-8"/>
...
let footer = `
<a href="https://github.com/haberdashPI/vscode-selection-utilities">View on GitHub</a>
</div>
</body>
</html>
`
        ...
        if(err){
            ...
            if(file == 'README.md'){
                str = str.replaceAll('https://haberdashpi.github.io/'+
                    'vscode-selection-utilities/stable', '.')
                str = str.replaceAll('./docs/images', '../images')
                debugger;
            }
