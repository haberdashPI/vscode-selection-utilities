export const commands = [
    ...
    },
    {
        ...
        items: [
            ...
            {text: 'moveCursorToNextBigWord', link: '/commands/moveCursorToNextBigWord.md'},
            {text: 'moveToNextBigWord', link: '/commands/moveToNextBigWord.md'},
            {text: 'selectToNextBigWord', link: '/commands/selectToNextBigWord.md'},
            ...
            {text: 'moveCursorToPreviousBigWord', link: '/commands/moveCursorToPreviousBigWord.md'},
            {text: 'moveToPreviousBigWord', link: '/commands/moveToPreviousBigWord.md'},
            {text: 'selectToPreviousBigWord', link: '/commands/selectToPreviousBigWord.md'},
